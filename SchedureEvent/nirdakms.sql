...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2025 at 01:34 AM
...
(6, 6, 'yvesrutembeza@gmail.com', NULL, 'pending', 0, '2025-04-24 22:50:17'),
(7, 7, 'zayves111@gmail.com', NULL, 'pending', 0, '2025-04-24 23:18:39'),
(8, 8, 'zayves111@gmail.com', NULL, 'pending', 0, '2025-04-24 23:28:52');
...
(11, 'rutembeza', 'yvesrutembeza@gmail.com', '$2y$10$0YD.evRN0nXseyxqcHEzn.mMIlG3qmupj3fq8GRKJssp4c9lyBd/.', 'Yves RUTEMBEZA', 3, NULL, NULL, NULL, '0787461999', 'English', 1, '2025-04-22 10:06:40', '2025-04-23 22:07:34');
...
--
ALTER TABLE `attendees`
  ADD CONSTRAINT `fk_attendee_event` FOREIGN KEY (`event_id`) REFERENCES `schedule_events` (`event_id`) ON DELETE CASCADE;
